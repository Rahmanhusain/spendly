...
export async function POST(request: Request) {
  ...
  try {
    ...
    response.cookies.set("adminAccessToken", tokens.accessToken, createAdminCookieOptions(3600));
    response.cookies.set("adminRefreshToken", tokens.refreshToken, createAdminCookieOptions(86400));
