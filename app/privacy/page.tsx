      ...
      <div className="mx-auto w-full max-w-5xl flex-1 px-4 py-12 sm:px-6 lg:px-8">
        <Card>
          ...
          <CardContent className="space-y-4 text-sm leading-7 text-slate-600">
            <p>
              We only collect the data needed to create workspaces, authenticate
              users, and support the product experience.
            </p>
            <p>
              Expense data remains scoped to the workspace and access role that
              created it.
            </p>
            <p>
